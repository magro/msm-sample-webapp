 ...
 */
@MountPath( path = "statefull3" )
@MountHybrid
public class StatefullPage3 extends BasePage {

    static final String MSG = "If you see this message wicket is properly configured and running";

    private static final Logger LOG = LoggerFactory.getLogger( StatefullPage3.class );
     ...
     *            Page parameters
     */
    public StatefullPage3( final PageParameters parameters ) {
        ...
        final Link<String> link = new Link<String>( "link", new Model<String>( "hello" ) ) {
            ...
            @Override
            public void onClick() {
                LOG.info( "Link clicked: " + getCounter().incrementAndGet() );
            }
        ...
        link.add( new Label( "linkLabel", new Model<String>() {
            ...
            public String getObject() {
                return "hit me! (already clicked " + getCounter().get() + " times) (i'm " + StatefullPage3.this + ")";
            }
    ...
    private AtomicInteger getCounter() {
        return MsmBenchSession.get().getOrCreateCounter( 0 );
    }
}
