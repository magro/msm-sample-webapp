<?xml version="1.0" encoding="UTF-8"?><railo-configuration password="4e2b58efaa47ccc837604a5cfe0fea295efab8bf904cc128b36499a2c465844d" version="2.0"><cfabort/>
...
<!--	or ask your database distributor 																-->
    ...
    <remote-clients directory="{railo-web}remote-client/" log="logs/" log-level="debug"/>
	...
	-->
	<scope applicationtimeout="1,0,0,0" cascade-to-resultset="true" cascading="standard" client-directory="{railo-web}/client-scope/" client-directory-max-size="100mb" clientmanagement="true" local-mode="update" merge-url-form="false" requesttimeout-log="{railo-web}/logs/requesttimeout.log" session-type="j2ee" sessionmanagement="true" sessiontimeout="0,0,30,0" setclientcookies="true" setdomaincookies="true"/>
	...
	-->
	<regional locale="de" timeserver="pool.ntp.org" timezone="Europe/Berlin"/>
